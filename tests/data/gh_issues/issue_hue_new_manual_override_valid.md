...
min_current_file_version: 0x01000000
invalid_xx: test
...
Testing manual override of min_current_file_version. User overrides the auto-calculated value with a lower (still reachable) one.
